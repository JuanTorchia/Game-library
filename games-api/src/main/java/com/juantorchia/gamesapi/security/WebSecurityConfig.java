package com.juantorchia.gamesapi.security;
...
public class WebSecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.authorizeRequests()
                .antMatchers(HttpMethod.GET, "/api/games", "/api/games/**", "/actuator/**").permitAll()
                .antMatchers("/api/games/**/comments").hasAnyRole(MOVIES_MANAGER, USER)
                .antMatchers("/api/games", "/api/games/**").hasRole(MOVIES_MANAGER)
