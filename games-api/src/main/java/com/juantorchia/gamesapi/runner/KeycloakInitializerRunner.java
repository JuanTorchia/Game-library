package com.juantorchia.gamesapi.runner;

import com.juantorchia.gamesapi.security.WebSecurityConfig;
...
public class KeycloakInitializerRunner implements CommandLineRunner {
    ...
    private static final String MOVIES_APP_CLIENT_ID = "games-app";
